...
const AnimatedFooter: React.FC<FooterProps> = ({
  ...
  return (
    <footer
      ref={footerRef}
      className="bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white relative flex flex-col w-full select-none"
    >
        ...
        <div className="space-y-4">
          ...
          <div className="text-right mt-4">
            <button 
              ...
              className="text-sm text-white/80 hover:text-blue-400 hover:underline inline-flex items-center transition-colors"
            >
              Back to top
            </button>
          </div>
